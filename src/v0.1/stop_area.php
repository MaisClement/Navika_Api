...
if ( isset($_GET['q']) && isset($_GET['lat']) && isset($_GET['lon']) ){
    ...
    $url = $BASE_URL . '/places?q=' . $query . '&from' . $lon .';' . $lat . '=&type[]=' . $type . '&depth=3&distance=1000';
    ...
    $url = $BASE_URL . '/coord/' . $lon .';' . $lat . '/places_nearby?type[]=' . $type . '&depth=3&distance=1000';
    ...
    $url = $BASE_URL . '/places?q=' . $query . '&type[]=' . $type . '&depth=3&distance=1000';
