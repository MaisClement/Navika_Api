...
/**
 * @extends ServiceEntityRepository<Attributions>
 *
...
class AttributionsRepository extends ServiceEntityRepository
{
    ...
    public function save(Attributions $entity, bool $flush = false): void
    {
    ...
    public function remove(Attributions $entity, bool $flush = false): void
    {
