 ...
 */
final class Version20230807211210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE route_sub (id INT AUTO_INCREMENT NOT NULL, subscriber_id_id INT DEFAULT NULL, route_id VARCHAR(255) DEFAULT NULL, monday ENUM(\'0\', \'1\'), tuesday ENUM(\'0\', \'1\'), wednesday ENUM(\'0\', \'1\'), thursday ENUM(\'0\', \'1\'), friday ENUM(\'0\', \'1\'), saturday ENUM(\'0\', \'1\'), sunday ENUM(\'0\', \'1\'), start_time TIME NOT NULL, end_time TIME NOT NULL, INDEX IDX_7A8B41B644E41CB0 (subscriber_id_id), INDEX IDX_7A8B41B634ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subscribers (id INT AUTO_INCREMENT NOT NULL, fcm_token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE timetable (id INT AUTO_INCREMENT NOT NULL, route_id VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, url VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_6B1F67034ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
