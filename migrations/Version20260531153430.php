 ...
 */
final class Version20260531153430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE provider CHANGE flag flag ENUM("0", "1", "2"), CHANGE type type ENUM("tc", "bikes", "other")');
        $this->addSql('ALTER TABLE route_sub CHANGE type type ENUM("alert", "all"), CHANGE monday monday ENUM("0", "1"), CHANGE tuesday tuesday ENUM("0", "1"), CHANGE wednesday wednesday ENUM("0", "1"), CHANGE thursday thursday ENUM("0", "1"), CHANGE friday friday ENUM("0", "1"), CHANGE saturday saturday ENUM("0", "1"), CHANGE sunday sunday ENUM("0", "1")');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE provider CHANGE flag flag VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL');
        $this->addSql('DROP INDEX stop_route_query ON stop_route');
