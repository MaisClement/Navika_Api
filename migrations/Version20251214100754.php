 ...
 */
final class Version20251214100754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agency (agency_id VARCHAR(255) NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, agency_name VARCHAR(255) NOT NULL, agency_url VARCHAR(255) DEFAULT NULL, agency_timezone VARCHAR(255) DEFAULT NULL, agency_lang VARCHAR(255) DEFAULT NULL, agency_phone VARCHAR(255) DEFAULT NULL, agency_fare_url VARCHAR(255) DEFAULT NULL, agency_email VARCHAR(255) DEFAULT NULL, INDEX IDX_70C0C6E6A53A8AA (provider_id), PRIMARY KEY(agency_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, service_id VARCHAR(255) NOT NULL, monday ENUM("0", "1"), tuesday ENUM("0", "1"), wednesday ENUM("0", "1"), thursday ENUM("0", "1"), friday ENUM("0", "1"), saturday ENUM("0", "1"), sunday ENUM("0", "1"), start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_6EA9A146A53A8AA (provider_id), INDEX calendar_service_id (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE calendar_dates (id INT AUTO_INCREMENT NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, service_id VARCHAR(255) NOT NULL, date DATE NOT NULL, exception_type ENUM("0", "1", "2"), INDEX IDX_C720CA70A53A8AA (provider_id), INDEX calendar_dates_service_id (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE maps (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, icon_url VARCHAR(255) DEFAULT NULL, number INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(255) NOT NULL, severity INT NOT NULL, effect VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, title VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, button VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, is_reduced TINYINT(1) NOT NULL, img VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE provider (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, area VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, flag ENUM("0", "1", "2"), type ENUM("tc", "bikes", "other"), gtfs_url VARCHAR(255) DEFAULT NULL, gbfs_url VARCHAR(255) DEFAULT NULL, gtfsrt_service_alerts VARCHAR(255) DEFAULT NULL, gtfsrt_vehicle_positions VARCHAR(255) DEFAULT NULL, gtfsrt_trip_updates VARCHAR(255) DEFAULT NULL, siri VARCHAR(255) DEFAULT NULL, parent_provider VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE route_sub (id INT AUTO_INCREMENT NOT NULL, subscriber_id_id INT DEFAULT NULL, route_id VARCHAR(255) DEFAULT NULL, type ENUM("alert", "all"), monday ENUM("0", "1"), tuesday ENUM("0", "1"), wednesday ENUM("0", "1"), thursday ENUM("0", "1"), friday ENUM("0", "1"), saturday ENUM("0", "1"), sunday ENUM("0", "1"), start_time TIME NOT NULL, end_time TIME NOT NULL, INDEX IDX_7A8B41B644E41CB0 (subscriber_id_id), INDEX IDX_7A8B41B634ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shapes (id INT AUTO_INCREMENT NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, shape_id VARCHAR(255) NOT NULL, geometry LINESTRING DEFAULT NULL COMMENT \'(DC2Type:linestring)\', route_id VARCHAR(255) DEFAULT NULL, INDEX IDX_93DBA512A53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, datetime DATETIME NOT NULL, uuid VARCHAR(255) NOT NULL, version VARCHAR(255) DEFAULT NULL, platform VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stop_route (route_key VARCHAR(255) NOT NULL, stop_id VARCHAR(255) NOT NULL, route_id VARCHAR(255) NOT NULL, town_id VARCHAR(255) DEFAULT NULL, route_short_name LONGTEXT DEFAULT NULL, route_long_name LONGTEXT DEFAULT NULL, route_type VARCHAR(255) NOT NULL, route_color VARCHAR(8) DEFAULT NULL, route_text_color VARCHAR(8) DEFAULT NULL, stop_name LONGTEXT NOT NULL, stop_query_name LONGTEXT NOT NULL, stop_lat VARCHAR(255) DEFAULT NULL, stop_lon VARCHAR(255) DEFAULT NULL, town_name VARCHAR(255) DEFAULT NULL, town_query_name VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, location_type VARCHAR(255) DEFAULT NULL, INDEX IDX_8F26CB4E75E23604 (town_id), INDEX stop_route_stop_id (stop_id), INDEX stop_route_query (stop_query_name), INDEX stop_route_query_town (town_query_name), INDEX stop_route_route_id (route_id), PRIMARY KEY(route_key)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stop_times (id INT AUTO_INCREMENT NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, trip_id VARCHAR(255) DEFAULT NULL, stop_id VARCHAR(255) DEFAULT NULL, arrival_time TIME DEFAULT NULL, departure_time TIME DEFAULT NULL, stop_sequence INT NOT NULL, stop_headsign VARCHAR(255) DEFAULT NULL, local_zone_id VARCHAR(255) DEFAULT NULL, pickup_type ENUM("0", "1", "2", "3"), drop_off_type ENUM("0", "1", "2", "3"), continuous_pickup ENUM("0", "1", "2", "3"), continuous_drop_off ENUM("0", "1", "2", "3"), timepoint ENUM("0", "1"), INDEX IDX_903505BBA53A8AA (provider_id), INDEX stop_times_trip_id (trip_id), INDEX stop_times_stop_id (stop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subscribers (id INT AUTO_INCREMENT NOT NULL, fcm_token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE temp_stop_route (route_key VARCHAR(255) NOT NULL, route_id VARCHAR(255) NOT NULL, route_short_name LONGTEXT DEFAULT NULL, route_long_name LONGTEXT DEFAULT NULL, route_type VARCHAR(255) NOT NULL, route_color VARCHAR(8) DEFAULT NULL, route_text_color VARCHAR(8) DEFAULT NULL, stop_id VARCHAR(255) NOT NULL, stop_name LONGTEXT NOT NULL, stop_query_name LONGTEXT NOT NULL, stop_lat VARCHAR(255) NOT NULL, stop_lon VARCHAR(255) NOT NULL, town_id VARCHAR(255) DEFAULT NULL, town_name VARCHAR(255) DEFAULT NULL, town_query_name VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, location_type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(route_key)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE timetables (id INT AUTO_INCREMENT NOT NULL, route_id VARCHAR(255) DEFAULT NULL, type ENUM("timetables", "map"), url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_4B0D0FC134ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trafic (id INT AUTO_INCREMENT NOT NULL, route_id VARCHAR(255) NOT NULL, report_id VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, cause VARCHAR(255) DEFAULT NULL, severity INT NOT NULL, effect VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, title LONGTEXT DEFAULT NULL, text LONGTEXT DEFAULT NULL, INDEX IDX_D279A2334ECB4E6 (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trafic_links (id INT AUTO_INCREMENT NOT NULL, report_id_id INT NOT NULL, link VARCHAR(255) NOT NULL, INDEX IDX_740901795558992E (report_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trips (trip_id VARCHAR(255) NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, route_id VARCHAR(255) DEFAULT NULL, service_id LONGTEXT DEFAULT NULL, trip_headsign LONGTEXT DEFAULT NULL, trip_short_name LONGTEXT DEFAULT NULL, direction_id ENUM("0", "1"), block_id VARCHAR(255) DEFAULT NULL, wheelchair_accessible ENUM("0", "1", "2"), bikes_allowed ENUM("0", "1", "2"), shape_id VARCHAR(255) NOT NULL, INDEX IDX_AA7370DAA53A8AA (provider_id), INDEX IDX_AA7370DA34ECB4E6 (route_id), INDEX trips_trip_short_name (trip_short_name), PRIMARY KEY(trip_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE route_sub ADD CONSTRAINT FK_7A8B41B644E41CB0 FOREIGN KEY (subscriber_id_id) REFERENCES subscribers (id)');
        $this->addSql('ALTER TABLE route_sub ADD CONSTRAINT FK_7A8B41B634ECB4E6 FOREIGN KEY (route_id) REFERENCES routes (route_id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE timetables ADD CONSTRAINT FK_4B0D0FC134ECB4E6 FOREIGN KEY (route_id) REFERENCES routes (route_id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE route_sub DROP FOREIGN KEY FK_7A8B41B644E41CB0');
        $this->addSql('ALTER TABLE route_sub DROP FOREIGN KEY FK_7A8B41B634ECB4E6');
        ...
        $this->addSql('ALTER TABLE timetables DROP FOREIGN KEY FK_4B0D0FC134ECB4E6');
        ...
        $this->addSql('DROP TABLE route_sub');
        ...
        $this->addSql('DROP TABLE timetables');
